                ...
                <div class="panel invoice" id="printablediv">
                    <div id="dvContents" class="panel-body">
                        <div class="row">
                            ...
                            <?php 
                            $invoiceno=$_GET['inv'];
                            $data=mysqli_query($GLOBALS["___mysqli_ston"], "select * from amount_detail_temp where invoice_no='$invoiceno'");
                        ...
                        <table class="table table-striped table-hover">
                            ...
                            <tbody>
                                <?php $rp_list=mysqli_query($GLOBALS["___mysqli_ston"], "select * from purchase_detail_temp where invoice_no='$invoiceno'");
