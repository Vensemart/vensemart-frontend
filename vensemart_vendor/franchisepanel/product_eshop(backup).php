...
if ($data2['qty']>'0') {
                              ...
                              $data1=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM `products` where product_id='".$data2['product_id']."'"));
                                    ?>
                                     <form name="add-to-cart" action="transfer_cart_update.php" method="post">
                                    ...
                                    <div class="col-item animateme scrollme" data-when="enter" data-from="0.2" data-to="0" data-crop="false" data-opacity="0" data-scale="0.5" style="opacity: 1; transform: translate3d(0px, 0px, 0px) rotateX(0deg) rotateY(0deg) rotateZ(0deg) scale3d(1, 1, 1);">
                                        ...
                                        <div class="info" style="max-height:190px !important;height:190px !immportant;">
                                            <div class="row">
