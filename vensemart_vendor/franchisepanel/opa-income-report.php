                      ...
                      <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box table-responsive">
                                    ...
                                    <h4 class="m-t-0 header-title"><b>Quick Promotion Bonus
</b></h4>
                                   ...
                                   <thead>
                                        ...
                                        <?php
                      $i=1;
                      $data=mysqli_query($GLOBALS["___mysqli_ston"], "select * from credit_debit where user_id='$userid' and ttype='Quick Promotion Bonus' order by id desc");
                     ...
                     ?>
                      ...
                      <tr>
                       ...
                       <!--  <td><?php echo $data11['first_name']." ".$data11['last_name'];?></td>
                        ...
                        <!--  <th><?php echo $data1['ewallet_used_by'];?></th> -->
