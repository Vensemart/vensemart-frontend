...
$withdrawalamt=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"],"select * from withdraw_request2 where id='".$id."'"));
...
mysqli_query($GLOBALS["___mysqli_ston"],"update withdraw_request2 set status='2',admin_remark='Withdrawal Cancelled By User',admin_response_date='$date' where id='$id'");
...
header("location:withdrawal-section2.php?msg=Withdrawal Request Cancelled!");
