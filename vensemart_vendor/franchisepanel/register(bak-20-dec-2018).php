...
<html lang="en">
  ...
  <script type="text/javascript">
    ...
    <title>Aveloun Registration</title>
              ...
              <?php @$msg=$_GET['msg'];if($msg!='') { ?>
                     <div class="reg-header">
                        <p align="right"> <br/><span style="color:#F00; float:right; font-weight:bold;"><?php if($msg=='ist') { echo "Register Successfully..! Please Check Your Email."; } else if($msg=='username') {  echo "Username Already Exists";} else if($msg=='sponsor') {  echo "Sponsor Not Exists or Wrong platform choosen by you";}  else if($msg=='email') { echo "Email Already Exists";}  else if($msg=='username1') { echo "Please Enter Username";} else if($msg=='platform') { echo "Please Select Package";} else if($msg=='position') { echo "Please Select Position"; } else { echo @$msg;} ?></span></p>                    
                          ...
                          <input type="text" class="form-control" placeholder="Sponsor Id"  name="sponsorid" required onblur="checkuser(this.value)"  autocomplete="off" placeholder="Please Enter Sponsor Id / Username" id="sponsorid" title="Sponsor name" value="<?php if($_SESSION['Ref_Name']!='') { echo $_SESSION['Ref_Name']; } else if($_SESSION['ref_id']!='') { echo $_SESSION['ref_id']; }  else {} ?>" <?php if($_SESSION['Ref_Name']!='') { ?> readonly <?php } ?>>&nbsp;&nbsp;&nbsp;&nbsp;
                            <span id="checksponser"></span> 
                                                      ...
                                                      <select class="form-control" name="binary_pos" id="binary_pos" required>
                                                          <option value="left">Select Position</option> 
                                                    ...
                                                    <div class="col-sm-6 mar-t-b">
                                                      <input class="form-control" placeholder="Enter Login Password"  type="password" name="password" required id="txtNewPassword" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,16}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8-16 characters">
                                                    </div>

                                                    <div class="col-sm-6 mar-t-b">
                                                      <input class="form-control" placeholder="Enter Transaction Password"  type="password" name="t_pass" required id="txtNewPassword1" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,16}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8-16 characters">
                                                    </div>

                                                     <div class="clearfix"></div>
                                                    
                                                     <div class="col-sm-12 mar-t-b">
                                                     <input class="form-control" placeholder="Please enter a valid email address" type="email"  name="email">
                                                    </div>
                                                   ...
                                                   <div class="clearfix"></div>
                                                    ...
                                                    <div class="col-sm-6 mar-t-b">
                                                      <input class="form-control" placeholder="Please enter your first name" name="firstname" id="firstname" required type="text">
                                                       <span id="efirstname" style="color:#FF0000;"></span>
                                                    </div>

                                                     <div class="col-sm-6 mar-t-b">
                                                      <input class="form-control" placeholder="Please enter your last name" name="lastname" id="lastname" required type="text">
                                                    ...
                                                    <div class="col-sm-6 mar-t-b">
                                                      <input class="form-control"  placeholder="Enter Mobile Number" type="number" name="phone" id="phone"  required>
                                                     <span id="ephone" style="color:#FF0000;"></span>
                                                       ...
                                                       <div class="col-sm-6 mar-t-b">
                                                      <input class="form-control"  placeholder="Enter Pan Card Number" type="text" name="passport" id="passport"  required>
                                                      <span id="epan" style="color:#FF0000;"></span>
                                                    </div>

                                                     <div class="col-sm-6 mar-t-b">
                                                      <input class="form-control"  placeholder="Enter Desired Userid" type="number" name="dziredid" id="dziredid"  >
...
if(lastname==''){
        $("#elastname").text("*Please enter the last name");
     
    }
    else if(!/^[A-Za-z0-9_. ]+$/.test(lastname)){
        $("#elastname").text("* You can not use Special Charecter");
     $("#lastname").val('');  
    }else{
     $("#elastname").text("");
    }
