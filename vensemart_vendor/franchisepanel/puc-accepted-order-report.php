            ...
            <div class="col-md-12">
              ...
              <section class="panel panel-primary">
                <header class="panel-heading">
                  <h4 class="panel-title">Accepted Orders</h4>
                </header>
                  ...
                  <table class="table datatable">
                    ...
                    <tbody>
                     ...
                     <?php
                      ...
                      // exit();
                      $data=mysqli_query($GLOBALS["___mysqli_ston"],  "select * from  amount_detail where order_status ='2' and seller_id='$userid' $query123 order by am_id desc");
