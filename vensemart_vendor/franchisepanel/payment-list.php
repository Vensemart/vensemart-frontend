            ...
            <div class="col-md-12">
              ...
              <section class="panel panel-primary">
                <header class="panel-heading">
                  <h4 class="panel-title"> Orders Payment</h4>
                </header>
                  ...
                  <table class="table datatable">
                    ...
                    <tbody>
                     <?php
                      ...
                      // exit();
                      $data=mysqli_query($GLOBALS["___mysqli_ston"],  "select * from  amount_detail where order_status ='4' and seller_id='$userid' $query123 order by am_id desc");
                     ...
                     ?>
                      ...
                      <tr>
                        ...
                        <!--<td><p>(Delivery Status: <?php if($data1['delst']==0){ echo 'Pending';} if($data1['delst']==1){ echo '<spam style="color:red;">Dispatched</spam>';} if($data1['delst']==2){ echo 'Delivered'; }?>)</p></td>-->
