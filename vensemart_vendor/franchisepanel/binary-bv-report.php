                ...
                <div class="panel-body">
                  ...
                  <table class="table datatable">
                    ...
                    <tbody>
                     ...
                     <?php
                      $i=1;
                      $data=mysqli_query($GLOBALS["___mysqli_ston"], "select * from manage_bv_history where income_id='$userid' order by id desc");
                     ...
                     ?>
                      ...
                      <tr>
                        <th scope="row"><?php echo $i;?></th>
                         <?php $data11=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select * from user_registration where user_id='".$data1['downline_id']."'"));?>
                        <td><?php echo $data11['first_name']." ".$data11['last_name'];?></td>
                         <td><?php echo $data1['downline_id'];?></td>
                          <td><?php echo $data1['pair'];?></td>
