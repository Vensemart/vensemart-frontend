...
<html lang="en">
  <head>
    ...
    <title> NETASK INDIA PVT. LTD  Forgot POC Password</title>
        ...
        <div class="panel-container">
          <section class="panel">
            <header class="panel-heading">
             <img src="../dashboard/images/logo2.png" class="width:180px;" class="big-logo">
              ...
              <form action="../post-action.php" method="post">
               <input name="action" type="hidden" value="ForgotPassword" />
                ...
                <div class="form-group">
                  ...
                  <input type="email" class="form-control" id="username" placeholder="Enter your User ID" value="" name="email" required>
                </div>
