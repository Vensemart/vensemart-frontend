            ...
            <div class="wrapper">
                ...
                <div class="row">
                    <div class="col-sm-12 text-right">
                       <!--  <a href="export_leadership_income_report.php" class="btn btn-success">Export In Excel</a> -->
                        ...
                        <table border="1px" class="table table-bordered table-hover role" style="background:#FFF; border-color:#000;">
                          ...
                          <tbody>
                            <?php
                              ...
                              $config_query_count="SELECT count(id) as counter from credit_debit where ttype='Direct Bonus' ";
                              $config_query_record="SELECT * from credit_debit where ttype='Direct Bonus' ";
