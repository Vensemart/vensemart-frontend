 ...
 <th>Manual Assign Order</th>                      
                    ...
                    <tbody>
                     ...
                     <?php
                      ...
                      // exit();
                      $data=mysqli_query($GLOBALS["___mysqli_ston"],  "select * from  amount_detail where order_status ='1' and seller_id='$userid' $query123 order by am_id desc");
                     ...
                     ?>
                      ...
                      <tr>
                        ...
                        <td><p>(<!-- Consignment No.= <?= $data1['dtdcno']?> /  -->Delivery Status: <?php if($data1['delst']==0){ echo 'Pending';} if($data1['delst']==1){ echo '<spam style="color:red;">Dispatched</spam>';} if($data1['delst']==2){ echo 'Delivered'; }?>)</p>
                        </td>
                        <td>
                       ...
                       <td><?php echo $data1['delivery_date'];?></td>
                           <td><a href="puc-shopping-invoice-detail.php?inv=<?php echo $data1['invoice_no'];?>" style="color: green;">View Invoice</a></td>
<td> Driver ID : <?php echo $data1['driver_id'];?></td>
<td>
    <?php if($data1['is_accepted']=='2'){ ?>
    <!--<button class="openmodel" data-id="<?php echo $data1['invoice_no'];?>" type="button" data-toggle="modal"  >Assign to Driver</button>-->
    <a class="btn btn-info" href="assign-order-driver.php?inv=<?php echo $data1['invoice_no'];?>&am_id=<?php echo $data1['am_id'];?>" style="color: green;">Assign to Driver</a>
<?php }else{ ?>

<span style='color:red;'>Already assign</span>
<?php   } ?> 
...
<form name="inactive" method="post" action="assign-order-driver.php">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
        <h4 class="modal-title">Assign to Driver</h4>
        
      </div>
      <div class="modal-body">
        <input type="hidden" id="setid" name="id" />
        <input type="hidden" id="setval" name="status"/>
        <input type="text" id="remark" name="driver_id" class="form-control" placeholder="Enter Driver id" autocomplete="off">
      </div>
