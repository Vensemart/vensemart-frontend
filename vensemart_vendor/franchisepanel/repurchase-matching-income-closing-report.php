...
<div class="col-sm-12">
<form name="tree" method="post" action="../champion_club.php" >
...
<input type="submit" name="submits" value="Submit" class="btn btn-success"> 
                ...
                <div class="row">
                    <!-- <div class="col-sm-12 text-right">
                        <a href="export-repurchase-matching-closing-reports.php"  class="btn btn-success">Export In Excel</a> 
                    </div> -->
                    <div class="col-sm-12">
                        <section class="panel">
                            <header class="panel-heading ">
                                 Direct Bonus Report<span style="float:right;color:red;"><?php echo @$_GET['msg'];?></span>
    ...
    <div class="total_invoice"  id="printArea">
                            ...
                            <?php 
                                  ...
                                  $total=0;
                                  $date=date('Y-m-d');
                                  $data=mysqli_query($GLOBALS["___mysqli_ston"], "select * from credit_debit where ttype='Direct Bonus' and receive_date='".date('Y-m-d')."'");
                            ...
                            <tr style="text-align:center;">
                                ...
                                <td>
                                  ...
                                  <td>
                                     <?php echo number_format($data1['Cause'],2);?>
                                </td>
                             
                               <td>
                                     <?php echo number_format($data1['credit_amt']+$data1['admin_charge'],2);?>
                                </td>
                                 <td>
                                     <?php echo number_format($data1['admin_charge'],2);?>
                                </td>
                                 <td>
                      ...
                      <td></td>
                      <td></td>
                      <td style="font-weight:bold;text-align:center;"><h4>Total  Bonus = </h4></td>
