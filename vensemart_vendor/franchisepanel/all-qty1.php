...
if($frm!='' && $til!='')
{
$query123="and  request_purchase_detail.purchase_date>='$fdate' and   request_purchase_detail.purchase_date<='$edate' ";  
                            ...
                            <?php 
                                  ...
                                  while($data1=mysqli_fetch_array($data))
                                    { 
                                      ...
                                      $tds=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "SELECT sum(request_purchase_detail.quantity) as sas FROM request_amount_detail INNER JOIN request_purchase_detail ON request_amount_detail.invoice_no = request_purchase_detail.invoice_no where request_purchase_detail.p_id='".$data1['product_id']."' and request_amount_detail.stock_point_id='$userid'  $query123"));
                                     $total=$total+$tds['sas'];
