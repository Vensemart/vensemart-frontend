           ...
           <form name="bankinfo" method="post" action="external-fund-transfer-confirm.php">
              <section class="panel">
                ...
                <header class="panel-heading">
                  <h3 class="panel-title">Fund-Wallet fund transfer</h3>
                </header>
                <header class="panel-heading">
                 <br/> <h3 class="panel-title">Fund-Wallet Ballance : INR <?php $data=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select * from poc_e_wallet where user_id='$userid'"));?><strong><?php  echo number_format($data['amount'],2);?></strong> </h3>
                <br/></header>
...
<input name="wallet" id="wallet" type="hidden" tabindex="1" required class="" style="width:4%;" value="poc_e_wallet" checked="checked" />
           ...
           <div class="form-group">
                      ...
                      <div class="input-group">
                        ...
                        <input type="text" name="user" required value="" class="form-control" id="userid">
                      </div>
