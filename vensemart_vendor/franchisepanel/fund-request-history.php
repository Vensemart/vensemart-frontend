            ...
            <div class="col-md-12">
              ...
              <section class="panel panel-primary">
                <header class="panel-heading">
                  <h4 class="panel-title">Add fund-request History</h4>
                </header>
                <div class="panel-body">
                  ...
                  <table class="table datatable">
                    ...
                    <tbody>
                     ...
                     <?php
                      $i=1;
                      $data=mysqli_query($GLOBALS["___mysqli_ston"], "select * from paymentproof where user='$userid'  order by id desc");
                     ...
                     ?>
                      ...
                      <tr>
                        ...
                        <?php $data11=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select * from user_registration where user_id='".$data1['user']."'"));?>
                        ...
                        <td><?php echo $data1['payment_mode'];?></td>
                          ...
                          <td><?php 
                                   if ($data1['status']=='1') {
                                     echo "Approved";
                                   }elseif ($data1['status']=='0' || $data1['status']=='Pending') {
                                      echo "Pending";
