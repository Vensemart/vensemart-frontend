				...
				<table class="table table-bordered text-center">
					 <tr>
					  <td><b>Empty</b></td>
					   <td><b>Member</b></td>
					  <td><b>Manager</b></td>
					  <td><b>Senior<br />Manager</b></td>
					  <td><b>Group<br />Manager</b></td>
					  <td><b>Manager<br />Mentor</b></td>
					  <td><b>Director</b></td>
					 </tr>
...
<input type="submit" name="submit" value="Search">&nbsp;&nbsp;&nbsp;&nbsp;<?php if($_GET['id']!='') { ?> <a href="www.mypage.com" onclick="window.history.go(-1); return false;"> <input type="button" value="Back" name="backs"> </a> <?php } ?>
</form> 
