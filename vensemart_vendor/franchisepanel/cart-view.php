                        ...
                        <div class="table-responsive">
                            ...
                            <?php if(!empty($_SESSION["cart_products"])){ ?>    
                                <tr>
                                  ...
                                  <!--<td colspan="5"><span style="float:right;text-align: right;font-weight: bold"><?php echo $shipping_cost. $list_tax; ?>Total Amount : <?php echo $currency; echo sprintf("%01.2f", $grand_total+$ttlgst); ?></span></td>-->
                                  <td colspan="5"><span style="float:right;text-align: right;font-weight: bold"><?php echo $shipping_cost. $list_tax; ?>Total Amount : <?php echo $currency; echo sprintf("%01.2f", $grand_total); ?></span></td>
                                  </tr>
                                <tr><td colspan="2"></td>
                                
                                <td colspan="5" class="text-right">&nbsp;<a href="eshop.php" class="btn btn-primary">Add More Items</a> &nbsp;<button type="submit" class="btn btn-primary">Update Your Cart</button> &nbsp; <a class="btn btn-primary" href="update-billing.php">  <!--ewallet-payment-shop.php-->Buy Now</a></td></tr>
                              ...
                              <?php }else{ ?>
                               <tr>
                                ...
                                <td colspan="5" class="text-right">&nbsp;<a href="eshop.php" class="btn btn-primary">Please Select Product</a></td></tr>
                              <?php } ?>
                              </tbody>
                            </table>
