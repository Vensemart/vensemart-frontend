...
$user_id2=$_GET['user_id'];
 ...
 $check_product7=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM `poc_product` where puc='".$f['user_id']."' and product_id='7' and type='Fresh'"));



 $check_product8=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM `poc_product` where puc='".$f['user_id']."' and product_id='8' and type='Fresh'"));


  if($check_product7['qty']<1 || $check_product8['qty']<1)
  {
    header("location:ewallet-downline-activate.php?user_id=$user_id2&msg=Stock not available!");
    exit;
  }
	...
	else
	{
		...
		if($newconts>0)
		{
      $reg_user=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select * from user_registration where (user_id='$user' || username='$user')"));
  ...
  $walls="Fund Wallet";
    ...
    $lfid="LJ".$activeuser_id.$rand;
			...
			mysqli_query($GLOBALS["___mysqli_ston"], "update user_registration set designation='Affiliate', user_rank_name ='Affiliate', user_plan='$plan',slab_rank='User' where user_id='$activeuser_id'");
 ...
 $poc_product_details7=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM `poc_product` where puc='".$f['user_id']."' and product_id='7' and type='Fresh'"));
 $poc_product_details71=$poc_product_details7['qty']-1;

   mysqli_query($GLOBALS["___mysqli_ston"], "update poc_product set qty='$poc_product_details71' where puc='".$f['user_id']."' and product_id='7' and   type='Fresh'");

 $poc_product_details8=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM `poc_product` where puc='".$f['user_id']."' and product_id='8' and type='Fresh'"));
$poc_product_details81=$poc_product_details8['qty']-1;

mysqli_query($GLOBALS["___mysqli_ston"], "update poc_product set qty='$poc_product_details81' where puc='".$f['user_id']."' and product_id='8' and   type='Fresh'");
