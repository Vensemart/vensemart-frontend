...
?>    
  ...
  <?php echo $userid;?><br/><?php echo $fz['first_name'];?> <br/> <?php echo date('d-m-Y',strtotime($fz['registration_date']));?>
                                  ...
                                  <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                    ...
                                    $regfse1=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select bv as total2 from manage_bv_history where income_id='".$userid."' and position='left' and description='Carry Forward BV' order by id desc limit 1")); 
                                    if($regfse1['total2']!='' || $regfse1['total2']!=0) { $leftx=$regfse1['total2']; } else { $leftx=0; }  
                                     ...
                                     $regfse2=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select bv as total2 from manage_bv_history where income_id='".$userid."' and position='right' and description='Carry Forward BV' order by id desc limit 1"));
...
?>
                ...
                <ul>
                  ...
                  <li>
                    <a  <?php if($userid !='' && $user1['user_id']==''){ ?> href="../register.php?pl_id=<?=$userid;?>&sponsor_id=<?=$id;?>&binary_pos=left" target="_blank" <?php } else { ?> href="binary-tree.php?id=<?=$user1['user_id'];?>" <?php } ?> class="tooltip1"> <?php if($user1['user_rank_name']=="Manager Mentor"){?><img src="images/manager-mentor.png" class="iicon"/><?php }else if($user1['user_rank_name']=="Manager"){?><img src="images/manager.png" class="iicon"/><?php }else if($user1['user_rank_name']=="Senior Manager"){?><img src="images/sm2.png" class="iicon"/><?php }else if($user1['user_rank_name']=="Group Manager"){?><img src="images/group-manager.png" class="iicon"/><?php }else if($user1['user_rank_name']=="Director"){?><img src="images/director.png" class="iicon"/><?php }  else if($user1['user_rank_name']=="Normal User"){?><img src="images/member.gif" class="iicon"/><?php }  else{?><img src="images/empty.gif" class="iicon"/><br/>Place<?php } ?><br /><?php if($user1['user_id']!='') { ?>
                                  <?=$user1['user_id']?><br/><?=$user1['first_name']?>  <br/> <?php echo date('d-m-Y',strtotime($user1['registration_date']));?>
                    ...
                    <span>
                                  ...
                                  <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                    ...
                                    $regfse1=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select bv as total2 from manage_bv_history where income_id='".$user1['user_id']."' and position='left' and description='Carry Forward BV' order by id desc limit 1")); 
                                    if($regfse1['total2']!='' || $regfse1['total2']!=0) { $leftx=$regfse1['total2']; } else { $leftx=0; }  
                                     ...
                                     $regfse2=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select bv as total2 from manage_bv_history where income_id='".$user1['user_id']."' and position='right' and description='Carry Forward BV' order by id desc limit 1"));
                                     if($regfse2['total2']!='' || $regfse2['total2']!=0) { $lefty=$regfse2['total2']; } else { $lefty=0; }
...
<tr>
                                  ...
                                  <?php 
                                    ...
                                    $regfse1=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select bv as total2 from manage_bv_history where income_id='".$user2['user_id']."' and position='left' and description='Carry Forward BV' order by id desc limit 1")); 
                                    if($regfse1['total2']!='' || $regfse1['total2']!=0) { $leftx=$regfse1['total2']; } else { $leftx=0; }  
                                     ...
                                     $regfse2=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select bv as total2 from manage_bv_history where income_id='".$user2['user_id']."' and position='right' and description='Carry Forward BV' order by id desc limit 1"));
                                     if($regfse2['total2']!='' || $regfse2['total2']!=0) { $lefty=$regfse2['total2']; } else { $lefty=0; }
                            ...
                            <ul>
                              ...
                              <li>
                           <a <?php if($info2 !='' && $user3['user_id']==''){ ?> href="../register.php?pl_id=<?=$info2;?>&sponsor_id=<?=$id;?>&binary_pos=left"  target="_blank" <?php } else { ?> href="binary-tree.php?id=<?=$user3['user_id']?>" <?php } ?> class="tooltip1">   <?php if($user3['user_rank_name']=="Manager Mentor"){?><img src="images/manager-mentor.png" class="iicon" /><?php }else if($user3['user_rank_name']=="Manager"){?><img src="images/manager.png" class="iicon" /><?php }else if($user3['user_rank_name']=="Senior Manager"){?><img src="images/sm2.png" class="iicon" /><?php }else if($user3['user_rank_name']=="Group Manager"){?><img src="images/group-manager.png" class="iicon" /><?php }else if($user3['user_rank_name']=="Director"){?><img src="images/director.png" class="iicon" /><?php }  else if($user3['user_rank_name']=="Normal User"){?><img src="images/member.gif" class="iicon" /><?php }  else{?><img src="images/empty.gif" class="iicon" /><br/>Place<?php } ?><?php if($user3['user_id']!='') { ?>
                               <br/>  <?=$user3['user_id']?><br/><?=$user3['first_name']?>  <br/> <?php echo date('d-m-Y',strtotime($user3['registration_date']));?>
...
<tr>
                                    ...
                                    $regfse1=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select bv as total2 from manage_bv_history where income_id='".$user3['user_id']."' and position='left' and description='Carry Forward BV' order by id desc limit 1")); 
                                    if($regfse1['total2']!='' || $regfse1['total2']!=0) { $leftx=$regfse1['total2']; } else { $leftx=0; }  
                                     ...
                                     $regfse2=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select bv as total2 from manage_bv_history where income_id='".$user3['user_id']."' and position='right' and description='Carry Forward BV' order by id desc limit 1"));
                                     if($regfse2['total2']!='' || $regfse2['total2']!=0) { $lefty=$regfse2['total2']; } else { $lefty=0; }
                                ...
                                <li>
                                  <a <?php if($info2 !='' && $user4['user_id']==''){ ?> href="../register.php?pl_id=<?=$info2;?>&sponsor_id=<?=$id;?>&binary_pos=right"  target="_blank" <?php } else { ?> href="binary-tree.php?id=<?=$user4['user_id']?>" <?php } ?> class="tooltip1"> <?php if($user4['user_rank_name']=="Manager Mentor"){?><img src="images/manager-mentor.png" class="iicon"/><?php }else if($user4['user_rank_name']=="Manager"){?><img src="images/manager.png" class="iicon"/><?php }else if($user4['user_rank_name']=="Senior Manager"){?><img src="images/sm2.png"  class="iicon"/><?php }else if($user4['user_rank_name']=="Group Manager"){?><img src="images/group-manager.png"  class="iicon"/><?php }else if($user4['user_rank_name']=="Director"){?><img src="images/director.png"  class="iicon"/><?php }  else if($user4['user_rank_name']=="Normal User"){?><img src="images/member.gif" class="iicon"/><?php }  else{?><img src="images/empty.gif"  class="iicon"/><br/>Place<?php } ?><?php if($user4['user_id']!='') { ?>
                                    <br/><?=$user4['user_id']?><br/><?=$user4['first_name']?>  <br/> <?php echo date('d-m-Y',strtotime($user4['registration_date']));?>
  ...
  <tr>
                                    ...
                                    $regfse1=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select bv as total2 from manage_bv_history where income_id='".$user4['user_id']."' and position='left' and description='Carry Forward BV' order by id desc limit 1")); 
                                    if($regfse1['total2']!='' || $regfse1['total2']!=0) { $leftx=$regfse1['total2']; } else { $leftx=0; }  
                                     ...
                                     $regfse2=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select bv as total2 from manage_bv_history where income_id='".$user4['user_id']."' and position='right' and description='Carry Forward BV' order by id desc limit 1"));
                                     if($regfse2['total2']!='' || $regfse2['total2']!=0) { $lefty=$regfse2['total2']; } else { $lefty=0; }
                          ...
                          <li>
                           <a <?php if($info1 !='' && $user5['user_id']==''){ ?> href="../register.php?pl_id=<?=$info1;?>&sponsor_id=<?=$id;?>&binary_pos=right"  target="_blank" <?php } else { ?> href="binary-tree.php?id=<?=$user5['user_id']?>" <?php } ?> class="tooltip1"> <?php if($user5['user_rank_name']=="Manager Mentor"){?><img src="images/manager-mentor.png" class="iicon"/><?php }else if($user5['user_rank_name']=="Manager"){?><img src="images/manager.png" class="iicon"/><?php }else if($user5['user_rank_name']=="Senior Manager"){?><img src="images/sm2.png" class="iicon"/><?php }else if($user5['user_rank_name']=="Group Manager"){?><img src="images/group-manager.png" class="iicon"/><?php }else if($user5['user_rank_name']=="Director"){?><img src="images/director.png" class="iicon"/><?php }  else if($user5['user_rank_name']=="Normal User"){?><img src="images/member.gif" class="iicon"/><?php }  else{?><img src="images/empty.gif" class="iicon"/><br/>Place<?php } ?><?php if($user5['user_id']!='') { ?>
                               <br/><?=$user5['user_id']?><br/><?=$user5['first_name']?>  <br/> <?php echo date('d-m-Y',strtotime($user5['registration_date']));?>
 ...
 <tr>
                                    ...
                                    $regfse1=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select bv as total2 from manage_bv_history where income_id='".$user5['user_id']."' and position='left' and description='Carry Forward BV' order by id desc limit 1")); 
                                    if($regfse1['total2']!='' || $regfse1['total2']!=0) { $leftx=$regfse1['total2']; } else { $leftx=0; }  
                                     ...
                                     $regfse2=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select bv as total2 from manage_bv_history where income_id='".$user5['user_id']."' and position='right' and description='Carry Forward BV' order by id desc limit 1"));
                                     if($regfse2['total2']!='' || $regfse2['total2']!=0) { $lefty=$regfse2['total2']; } else { $lefty=0; }
                              ...
                              <ul>
                                ...
                                <li>
                                  <a <?php if($info5 !='' && $user6['user_id']==''){ ?> href="../register.php?pl_id=<?=$info5;?>&sponsor_id=<?=$id;?>&binary_pos=left"  target="_blank" <?php } else { ?> href="binary-tree.php?id=<?=$user6['user_id']?>" <?php } ?> class="tooltip1"> <?php if($user6['user_rank_name']=="Manager Mentor"){?><img src="images/manager-mentor.png" class="iicon" /><?php }else if($user6['user_rank_name']=="Manager"){?><img src="images/manager.png" class="iicon"/><?php }else if($user6['user_rank_name']=="Senior Manager"){?><img src="images/sm2.png" class="iicon"/><?php }else if($user6['user_rank_name']=="Group Manager"){?><img src="images/group-manager.png" class="iicon"/><?php }else if($user6['user_rank_name']=="Director"){?><img src="images/director.png" class="iicon"/><?php }  else if($user6['user_rank_name']=="Normal User"){?><img src="images/member.gif" class="iicon"/><?php }  else{?><img src="images/empty.gif" class="iicon"/><br/>Place<?php } ?><?php if($user6['user_id']!='') { ?>
                                    <br/><?=$user6['user_id']?><br/><?=$user6['first_name']?> <br/> <?php echo date('d-m-Y',strtotime($user6['registration_date']));?>
 ...
 <tr>
                                    ...
                                    $regfse1=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select bv as total2 from manage_bv_history where income_id='".$user6['user_id']."' and position='left' and description='Carry Forward BV' order by id desc limit 1")); 
                                    if($regfse1['total2']!='' || $regfse1['total2']!=0) { $leftx=$regfse1['total2']; } else { $leftx=0; }  
                                     ...
                                     $regfse2=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select bv as total2 from manage_bv_history where income_id='".$user6['user_id']."' and position='right' and description='Carry Forward BV' order by id desc limit 1"));
                                     if($regfse2['total2']!='' || $regfse2['total2']!=0) { $lefty=$regfse2['total2']; } else { $lefty=0; }
                                  ...
                                  <li>
                                     <a <?php if($info5 !='' && $user7['user_id']==''){ ?> href="../register.php?pl_id=<?=$info5;?>&sponsor_id=<?=$id;?>&binary_pos=right"  target="_blank" <?php } else { ?> href="binary-tree.php?id=<?=$user7['user_id']?>" <?php } ?> class="tooltip1"> <?php if($user7['user_rank_name']=="Manager Mentor"){?><img src="images/manager-mentor.png" class="iicon"/><?php }else if($user7['user_rank_name']=="Manager"){?><img src="images/manager.png"  class="iicon"/><?php }else if($user7['user_rank_name']=="Senior Manager"){?><img src="images/sm2.png" class="iicon"/><?php }else if($user7['user_rank_name']=="Group Manager"){?><img src="images/group-manager.png" class="iicon"/><?php }else if($user7['user_rank_name']=="Director"){?><img src="images/director.png"  class="iicon"/><?php }  else if($user7['user_rank_name']=="Normal User"){?><img src="images/member.gif" class="iicon"/><?php }  else {?><img src="images/empty.gif" class="iicon"/><br/>Place<?php } ?> <?php if($user7['user_id']!='') { ?>
                                    <br/><?=$user7['user_id']?><br/><?=$user7['first_name']?> <br/> <?php echo date('d-m-Y',strtotime($user7['registration_date']));?>
   ...
   <tr>
                                    ...
                                    $regfse1=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select bv as total2 from manage_bv_history where income_id='".$user7['user_id']."' and position='left' and description='Carry Forward BV' order by id desc limit 1")); 
                                    if($regfse1['total2']!='' || $regfse1['total2']!=0) { $leftx=$regfse1['total2']; } else { $leftx=0; }  
                                     ...
                                     $regfse2=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select bv as total2 from manage_bv_history where income_id='".$user7['user_id']."' and position='right' and description='Carry Forward BV' order by id desc limit 1"));
                                     if($regfse2['total2']!='' || $regfse2['total2']!=0) { $lefty=$regfse2['total2']; } else { $lefty=0; }
                    ...
                    <li>
                    <a <?php if($userid !='' && $user8['user_id']==''){ ?> href="../register.php?pl_id=<?=$userid;?>&sponsor_id=<?=$id;?>&binary_pos=right" target="_blank"  <?php } else { ?>  href="binary-tree.php?id=<?=$user8['user_id']?>" <?php } ?> class="tooltip1">   <?php if($user8['user_rank_name']=="Manager Mentor"){?><img src="images/manager-mentor.png" class="iicon"/><?php }else if($user8['user_rank_name']=="Manager"){?><img src="images/manager.png" class="iicon"/><?php }else if($user8['user_rank_name']=="Senior Manager"){?><img src="images/sm2.png" class="iicon"/><?php }else if($user8['user_rank_name']=="Group Manager"){?><img src="images/group-manager.png" class="iicon"/><?php }else if($user8['user_rank_name']=="Director"){?><img src="images/director.png" class="iicon"/><?php }  else if($user8['user_rank_name']=="Normal User"){?><img src="images/member.gif" class="iicon"/><?php }  else{?><img src="images/empty.gif" class="iicon"/><br/>Place<?php } ?> <?php if($user8['user_id']!='') { ?>
                                    <br/><?=$user8['user_id']?><br/><?=$user8['first_name']?> <br/> <?php echo date('d-m-Y',strtotime($user8['registration_date']));;?>
   ...
   <tr>
                                  ...
                                  <tr>
                                    ...
                                    $regfse1=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select bv as total2 from manage_bv_history where income_id='".$user8['user_id']."' and position='left' and description='Carry Forward BV' order by id desc limit 1")); 
                                    if($regfse1['total2']!='' || $regfse1['total2']!=0) { $leftx=$regfse1['total2']; } else { $leftx=0; }  
                                     ...
                                     $regfse2=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select bv as total2 from manage_bv_history where income_id='".$user8['user_id']."' and position='right' and description='Carry Forward BV' order by id desc limit 1"));
                                     if($regfse2['total2']!='' || $regfse2['total2']!=0) { $lefty=$regfse2['total2']; } else { $lefty=0; }
                      ...
                      <ul>
                        ...
                        <li>
                          <a <?php if($info8 !='' && $user9['user_id']==''){ ?> href="../register.php?pl_id=<?=$info8;?>&sponsor_id=<?=$id;?>&binary_pos=left" target="_blank"  <?php } else { ?> href="binary-tree.php?id=<?=$user9['user_id']?>" <?php } ?> class="tooltip1"> <?php if($user9['user_rank_name']=="Manager Mentor"){?><img src="images/manager-mentor.png" class="iicon" /><?php }else if($user9['user_rank_name']=="Manager"){?><img src="images/manager.png" class="iicon"/><?php }else if($user9['user_rank_name']=="Senior Manager"){?><img src="images/sm2.png" class="iicon"/><?php }else if($user9['user_rank_name']=="Group Manager"){?><img src="images/group-manager.png" class="iicon"/><?php }else if($user9['user_rank_name']=="Director"){?><img src="images/director.png" class="iicon"/><?php }  else if($user9['user_rank_name']=="Normal User"){?><img src="images/member.gif" class="iicon"/><?php }  else{?><img src="images/empty.gif" class="iicon"/><br/>Place<?php } ?><?php if($user9['user_id']!='') { ?>
                                    <br/><?=$user9['user_id']?><br/><?=$user9['first_name']?>   <br/> <?php echo date('d-m-Y',strtotime($user9['registration_date']));?>
  ...
  <tr>
                                ...
                                <tr>
                                    ...
                                    $regfse1=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select bv as total2 from manage_bv_history where income_id='".$user9['user_id']."' and position='left' and description='Carry Forward BV' order by id desc limit 1")); 
                                    if($regfse1['total2']!='' || $regfse1['total2']!=0) { $leftx=$regfse1['total2']; } else { $leftx=0; }  
                                     ...
                                     $regfse2=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select bv as total2 from manage_bv_history where income_id='".$user9['user_id']."' and position='right' and description='Carry Forward BV' order by id desc limit 1"));
                                     if($regfse2['total2']!='' || $regfse2['total2']!=0) { $lefty=$regfse2['total2']; } else { $lefty=0; }
                            ...
                            <ul>
                              ...
                              <li>
                               <a <?php if($info9 !='' && $user10['user_id']==''){ ?> href="../register.php?pl_id=<?=$info9;?>&sponsor_id=<?=$id;?>&binary_pos=left"  target="_blank" <?php } else { ?>  href="binary-tree.php?id=<?=$user10['user_id']?>" <?php } ?> class="tooltip1"><?php if($user10['user_rank_name']=="Manager Mentor"){?><img src="images/manager-mentor.png" class="iicon" /><?php }else if($user10['user_rank_name']=="Manager"){?><img src="images/manager.png"  class="iicon" /><?php }else if($user10['user_rank_name']=="Senior Manager"){?><img src="images/sm2.png" class="iicon" /><?php }else if($user10['user_rank_name']=="Group Manager"){?><img src="images/group-manager.png" class="iicon" /><?php }else if($user10['user_rank_name']=="Director"){?><img src="images/director.png" class="iicon" /><?php }  else if($user10['user_rank_name']=="Normal User"){?><img src="images/member.gif" class="iicon" /><?php }  else{?><img src="images/empty.gif" class="iicon" /><br/>Place<?php } ?><?php if($user10['user_id']!='') { ?>
  <br/><?=$user10['user_id']?><br/><?=$user10['first_name']?>  <br/> <?php echo date('d-m-Y',strtotime($user10['registration_date']));?>
                                ...
                                <li>
                                  <a <?php if($info9 !='' && $user11['user_id']==''){ ?> href="../register.php?pl_id=<?=$info9;?>&sponsor_id=<?=$id;?>&binary_pos=right" target="_blank"  <?php } else { ?>  href="binary-tree.php?id=<?=$user11['user_id']?>" <?php } ?> class="tooltip1">  <?php if($user11['user_rank_name']=="Manager Mentor"){?><img src="images/manager-mentor.png" class="iicon" /><?php }else if($user11['user_rank_name']=="Manager"){?><img src="images/manager.png" class="iicon" /><?php }else if($user11['user_rank_name']=="Senior Manager"){?><img src="images/sm2.png" class="iicon" /><?php }else if($user11['user_rank_name']=="Group Manager"){?><img src="images/group-manager.png" height="45" class="iicon" /><?php }else if($user11['user_rank_name']=="Director"){?><img src="images/director.png" class="iicon" /><?php }  else if($user11['user_rank_name']=="Normal User"){?><img src="images/member.gif" class="iicon" /><?php }  else{?><img src="images/empty.gif" class="iicon" /><br/>Place<?php } ?> <?php if($user11['user_id']!='') { ?>
  <br/><?=$user11['user_id']?><br/><?=$user11['first_name']?>   <br/> <?php echo date('d-m-Y',strtotime($user11['registration_date']));?>
  ...
  <tr>
                                   ...
                                   <tr>
                                      <td align="left">Total BV:</td>
                                      <td align="left">L: <?php $regfs1e=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select sum(bv) as total1e from manage_bv_history where income_id='".$user11['user_id']."' and position='left' and description!='Carry Forward BV'")); if($regfs1e['total1e']!='' || $regfs1e['total1e']!=0) { echo $regfs1e['total1e']; } else { echo "0"; } ?> | R: <?php $regfs2=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select sum(bv) as total2 from manage_bv_history where income_id='".$user11['user_id']."' and position='right' and description!='Carry Forward BV'")); if($regfs2['total2']!='' || $regfs2['total2']!=0) { echo $regfs2['total2']; } else { echo "0"; }  ?></td>
                                    </tr>
                                    ...
                                    $regfse1=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select bv as total2 from manage_bv_history where income_id='".$user11['user_id']."' and position='left' and description='Carry Forward BV' order by id desc limit 1")); 
                                    if($regfse1['total2']!='' || $regfse1['total2']!=0) { $leftx=$regfse1['total2']; } else { $leftx=0; }  
                                     ...
                                     $regfse2=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select bv as total2 from manage_bv_history where income_id='".$user11['user_id']."' and position='right' and description='Carry Forward BV' order by id desc limit 1"));
                                     if($regfse2['total2']!='' || $regfse2['total2']!=0) { $lefty=$regfse2['total2']; } else { $lefty=0; }
                          ...
                          <li>
                            <a <?php if($info8 !='' && $user12['user_id']==''){ ?> href="../register.php?pl_id=<?=$info8;?>&sponsor_id=<?=$id;?>&binary_pos=right"  target="_blank" <?php } else { ?>  href="binary-tree.php?id=<?=$user12['user_id']?>" <?php } ?> class="tooltip1">  <?php if($user12['user_rank_name']=="Manager Mentor"){?><img src="images/manager-mentor.png" class="iicon" /><?php }else if($user12['user_rank_name']=="Manager"){?><img src="images/manager.png" class="iicon" /><?php }else if($user12['user_rank_name']=="Senior Manager"){?><img src="images/sm2.png" class="iicon" /><?php }else if($user12['user_rank_name']=="Group Manager"){?><img src="images/group-manager.png" class="iicon" /><?php }else if($user12['user_rank_name']=="Director"){?><img src="images/director.png" class="iicon" /><?php }  else if($user12['user_rank_name']=="Normal User"){?><img src="images/member.gif" class="iicon" /><?php }  else{?><img src="images/empty.gif"  class="iicon" /><br/>Place<?php } ?><?php if($user12['user_id']!='') { ?>
  <br/><?=$user12['user_id']?><br/><?=$user12['first_name']?>  <br/> <?php echo date('d-m-Y',strtotime($user12['registration_date']));?>
 				    ...
 				    <tr>
                                    ...
                                    $regfse1=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select bv as total2 from manage_bv_history where income_id='".$user12['user_id']."' and position='left' and description='Carry Forward BV' order by id desc limit 1")); 
                                    if($regfse1['total2']!='' || $regfse1['total2']!=0) { $leftx=$regfse1['total2']; } else { $leftx=0; }  
                                     ...
                                     $regfse2=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select bv as total2 from manage_bv_history where income_id='".$user12['user_id']."' and position='right' and description='Carry Forward BV' order by id desc limit 1"));
                                     if($regfse2['total2']!='' || $regfse2['total2']!=0) { $lefty=$regfse2['total2']; } else { $lefty=0; }
  ...
  <tr>
                                    ...
                                    $regfse1=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select bv as total2 from manage_bv_history where income_id='".$user13['user_id']."' and position='left' and description='Carry Forward BV' order by id desc limit 1")); 
                                    if($regfse1['total2']!='' || $regfse1['total2']!=0) { $leftx=$regfse1['total2']; } else { $leftx=0; }  
                                     ...
                                     $regfse2=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select bv as total2 from manage_bv_history where income_id='".$user13['user_id']."' and position='right' and description='Carry Forward BV' order by id desc limit 1"));
                                     if($regfse2['total2']!='' || $regfse2['total2']!=0) { $lefty=$regfse2['total2']; } else { $lefty=0; }
                                  ...
                                  <li>
                                   <a <?php if($info12 !='' && $user14['user_id']==''){ ?> href="../register.php?pl_id=<?=$info12;?>&sponsor_id=<?=$id;?>&binary_pos=right" target="_blank"  <?php } else { ?>  href="binary-tree.php?id=<?=$user14['user_id']?>" <?php } ?> class="tooltip1">  <?php if($user14['user_rank_name']=="Manager Mentor"){?><img src="images/manager-mentor.png" class="iicon" /><?php }else if($user14['user_rank_name']=="Manager"){?><img src="images/manager.png" class="iicon" /><?php } else if($user14['user_rank_name']=="Senior Manager"){?><img src="images/sm2.png" class="iicon" /><?php } else if($user14['user_rank_name']=="Group Manager"){?><img src="images/group-manager.png" class="iicon" /><?php } else if($user14['user_rank_name']=="Director"){?><img src="images/director.png" class="iicon" /><?php } else if($user14['user_rank_name']=="Normal User"){?><img src="images/member.gif" class="iicon" /><?php }  else{?><img src="images/empty.gif" class="iicon" /><br/>Place<?php } ?>   <?php if($user14['user_id']!='') { ?>

  <br/><?=$user14['user_id']?><br/><?=$user14['first_name']?>   <br/> <?php echo date('d-m-Y',strtotime($user14['registration_date']));?>
 ...
 <tr>
  ...
  <tr>
                                    ...
                                    $regfse1=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select bv as total2 from manage_bv_history where income_id='".$user14['user_id']."' and position='left' and description='Carry Forward BV' order by id desc limit 1")); 
                                    if($regfse1['total2']!='' || $regfse1['total2']!=0) { $leftx=$regfse1['total2']; } else { $leftx=0; }  
                                     ...
                                     $regfse2=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select bv as total2 from manage_bv_history where income_id='".$user14['user_id']."' and position='right' and description='Carry Forward BV' order by id desc limit 1"));
                                     if($regfse2['total2']!='' || $regfse2['total2']!=0) { $lefty=$regfse2['total2']; } else { $lefty=0; }
