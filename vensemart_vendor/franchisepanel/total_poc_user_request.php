            ...
            <div class="col-md-12">
              ...
              <section class="panel panel-primary">
                <header class="panel-heading">
                  <h4 class="panel-title">Activated Request</h4>
                  ...
                  <table class="table datatable">
                    <thead>
                     ...
                     <tbody>
                            <?php 
                                  $i=1;
                                  $data=mysqli_query($GLOBALS["___mysqli_ston"], "select * from user_registration where puc='".$f['user_id']."' and designation='Affiliate'");
