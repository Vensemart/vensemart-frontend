...
$cgst = ($newamt*9)/100;
$sgst = ($newamt*9)/100;
$subtotal = ($newamt+$cgst+$sgst);

?>
INR <?php echo number_format($subtotal,2);?>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-xs-4">
                                ...
                                <address>
                                    ...
                                    <br>Skyinfo Enterprises Private LTD <br/>
B-86, Sector-60,Noida, U.P-201301<br/>
Tel: (+91)  9910321194, 7500500557<br/>
Email: skyinfo.query@gmail.com
 ...
 $package123=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select * from status_maintenance where id='$lfj[package]'"));

 echo $package123['name'];?></td>
                                <td class="hidden-xs"><?php echo $lfj['remark'];?></td>
                                <td class=""><?php echo number_format($newamt,2);?></td>
                                <td class="">1</td>
                                <td><?php echo number_format($newamt,2);?></td>
                            </tr>
                            ...
                            <div class="col-xs-4">
                                <table class="table table-hover">
                                    <tbody>
                                        <tr>
                                        <td>CGST</td>
                                        <td><?php echo number_format($cgst,2);?> INR</td>
                                    </tr>
                                    <tr>
                                        <td>SGST</td>
                                        <td><?php echo number_format($cgst,2);?> INR</td>
                                    ...
                                    <tr>
                                        <td>Subtotal</td>
                                        <td><?php echo number_format($subtotal,2);?> INR</td>
                                    </tr>
                                   <!-- <tr>
                                        <td>Tax</td>
                                        <td>0.00</td>
                                    ...
                                    <tr>
                                        ...
                                        <td><strong><?php echo number_format($subtotal,2);?> INR</strong></td>
                                    </tr>
                                    </tbody>
                                </table>
                            </div>
