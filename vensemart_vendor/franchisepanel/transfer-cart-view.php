...
<header class="panel-heading">
    ...
    $poc_product_details=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM `poc_product` where puc='".$f['user_id']."' and product_id='$product_id'"));
                                  ...
                                  echo '<td>'.$poc_product_details['qty'].'</td>';
                              ...
                              */}
                                ...
                                <td colspan="5" class="text-right">&nbsp;<a href="product_eshop.php" class="btn btn-primary">Add More Items</a> &nbsp;<button type="submit" class="btn btn-primary">Update Your Cart</button> &nbsp; <a class="btn btn-primary" href="transfer-shop-product.php"> Transfer Now</a></td></tr>
                              </tbody>
                            </table>
