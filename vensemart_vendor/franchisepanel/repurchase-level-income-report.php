...
<!--                                    <h4 class="m-t-0 header-title"><b>Super Champion Bonus-->
<!--</b></h4>-->
                                   <h4 class="m-t-0 header-title"><b>Repurchasing Bonus
</b></h4>  
                                   ...
                                   <thead>
                                        ...
                                        <?php
                      $i=1;
                      $data=mysqli_query($GLOBALS["___mysqli_ston"], "select * from credit_debit where user_id='$userid' and ttype='Repurchasing Bonus' order by id desc");
