...
&& $imageFileType != "gif") {
   ...
   mysqli_query($GLOBALS["___mysqli_ston"], "INSERT INTO `paymentproof_poc` (`id`, `user`, `bank`, `amount`, `tranno`, `paymentproof`, `posteddate`, `status`,`bank_name`,`payment_mode`,`amount_used`) VALUES (NULL, '".$f['user_id']."', '$bank', '$amount', '$trannumber', '$filename12', '".date('Y-m-d')."', 'Pending', '$bank_name', '$payment_mode', '$amount_used')");
...
<input name="wallet" id="wallet" type="hidden" tabindex="1" required class="" style="width:4%;" value="final_e_wallet" checked="checked" />
           ...
           <div class="form-group">
                      ...
                      <div class="input-group">
                        ...
                        <select name="bank" required class="form-control" id="exampleInputAddress">
                        <!--<option value="RBL Bank">RBL Bank ( Account Number : 409000845103)</option>-->
                       
 <?php 
                                  $i=1;
                                  $data=mysqli_query($GLOBALS["___mysqli_ston"], "select * from bank_details_manage ");
                                  while($data1=mysqli_fetch_array($data))
                                    { ?>
                        <option value="<?php echo $data1['bank_name'];?>"><?php echo $data1['bank_name'];?> ( Account Number : <?php echo $data1['acc_no'];?>)</option>
 ...
 <?php $i++;} ?>
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        <span class="input-group-addon"></span>
                        <select name="payment_mode" required class="form-control" id="exampleInputAddress">
                        <option value="Check Deposit">Check Deposit</option>
                        <option value="NEFT">NEFT</option>
                        <option value="IMPS">IMPS</option>
                        <option value="RTGS">NEFT</option>
                       ...
                       <div class="form-group">
                      <label for="exampleInputAddress">Enter Amount Deposited</label>
                      <div class="input-group">
                        <span class="input-group-addon"></span>
                      ...
                      <div class="input-group">
                        <span class="input-group-addon"></span>
                        <input type="text" name="trannumber" required value="" class="form-control" id="exampleInputAddress">
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                      <label for="exampleInputAddress">Upload the payment proof</label>
                      <div class="input-group">
                        <span class="input-group-addon"></span>
