...
<html>
    ...
    <body>
        ...
        <!--    <?php }else{ ?><p style="color: red;font-style: italic;font-weight: 600;">Withdrawal can only be rquested at Tuesday</p> <?php }?> -->
         ...
         <a href="withdraw-request3.php"><input type="submit" name="update" value="New Request Click Here" class="btn btn-primary btn-large"></a>  
        ...
        <section class="panel panel-primary">
                ...
                <div class="panel-body table-responsive">
                    ...
                    <tbody>
                     <?php
                      $i=1;
                      $data=mysqli_query($GLOBALS["___mysqli_ston"], "select * from withdraw_request_cp where user_id='$userid' order by id desc");
...
$data22=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select * from user_registration where user_id='".$data1['mentor']."'"));?>
                    ...
                    <td><?php if($data1['status']==0)
                                    { 
                                        //echo "Pending";  ?>
                <a href="cancelled_user_withdrawal3.php?user=<?php echo $data1['user_id'];?>&id=<?php echo $data1['id'];?>" class="btn btn-danger" title="Click To Cancel">Cancel Request</a>
                                    <?php }
                                      if($data1['status']==1)
                                    { 
                                        echo "Paid";
