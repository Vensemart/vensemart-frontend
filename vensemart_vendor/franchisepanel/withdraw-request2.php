        ...
        <div id="wrapper">
           ...
           <?php  include("includes/sidebar.php"); ?>
            ...
            <!-- ============================================================== -->
              ...
              <form name="bankinfo" method="post" action="withdrawal-request-confirm2.php">
              <section class="panel">

                <header class="panel-heading">
                  <h3 class="panel-title">Withdrawal Request Form</h3>
                <br/>
                 <br/> <h3 class="panel-title">Flex Investment Profit Wallet : $ <?php $data=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select * from investment_profit_wallet where user_id='$userid'"));?><strong><?php echo number_format($_SESSION['rates']*$data['amount'],2);?></strong></h3><br/>
...
<input name="wallet" id="wallet" type="hidden" tabindex="1" required class="" style="width:4%;" value="investment_profit_wallet" checked="checked" />
