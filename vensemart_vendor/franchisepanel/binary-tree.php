...
<?php 
 // echo "select sum(bv) as totalleftamount from manage_bv_history where status='0' and income_id='".$f['user_id']."' and position='left' and description!='Next Pair Forwarded' and description!='Carry Forward BV'";           
  $querys1=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select sum(bv) as totalleftamount from manage_bv_history where status='0' and income_id='".$f['user_id']."' and position='left' and description!='Next Pair Forwarded' and description!='Carry Forward BV'"));
        // print_r($querys1);
                           ...
                           $leftamt1=$querys1['totalleftamount'];
                            ...
                            $querys12=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select sum(bv) as totalrightamount from manage_bv_history where status='0' and income_id='".$f['user_id']."' and position='right'  and description!='Next Pair Forwarded' and description!='Carry Forward BV'"));
...
?>
                                        ...
                                        <div class="media-body" style="text-align:center;">
                                            <h5 class="md-title nomargin white">Total PV</h5>
                                            <h2 class="mt5 white">Left : <?php echo $leftamt1;?> | Right  : <?php echo $rightamt1;?></h2>
                                        </div>
    ...
    <?php  if($fz['user_rank_name']=="Manager Mentor"){?><img src="images/manager-mentor.png" class="iicon"/><?php } else if($fz['designation']=='Affiliate'){ ?><img src="images/man.png" class="iicon"/> <? }else if($fz['designation']=='Free User'){ ?><img src="images/redman.png" class="iicon"/> <? }else if($fz['designation']=='Affiliate'){ ?><img src="images/man.png" class="iicon"/> <? }else if($fz['designation']=='Free User'){ ?><img src="images/redman.png" class="iicon"/> <? }else if($fz['designation']=='Affiliate'){ ?><img src="images/man.png" class="iicon"/> <? }else if($fz['designation']=='Free User'){ ?><img src="images/redman.png" class="iicon"/> <? }       else if($fz['user_rank_name']=="Manager"){?><img src="images/manager.png" class="iicon"/><?php }else if($fz['user_rank_name']=="Senior Manager"){?><img src="images/sm2.png" class="iicon"/><?php }else if($fz['user_rank_name']=="Group Manager"){?><img src="images/group-manager.png" class="iicon"/><?php }else if($fz['user_rank_name']=="Director"){?><img src="images/director.png" class="iicon"/><?php }  else if($fz['user_rank_name']=="Normal User"){?><img src="images/member.gif" class="iicon"/><?php }  else{?><img src="images/user.png" class="iicon"/><br/><?php } ?>
                    ...
                    <span>
                      ...
                      <ul>
                        ...
                        <li>
                          ...
                          <a  <?php if($info1 !='' && $user2['user_id']==''){ ?> href="register.php?pl_id=<?=$info1;?>&sponsor_id=<?=$id;?>&binary_pos=left"  target="_blank" <?php } else { ?> href="binary-tree.php?id=<?=$user2['user_id']?>" <?php } ?> class="tooltip1"> <?php if($user2['user_rank_name']=="Manager Mentor"){?><img src="images/manager-mentor.png" class="iicon"/><?php }else if($user2['user_rank_name']=="Manager"){?><img src="images/manager.png" class="iicon"/><?php }else if($user2['designation']=='Affiliate'){ ?><img src="images/man.png" class="iicon"/> <? }else if($user2['designation']=='Free User'){ ?><img src="images/redman.png" class="iicon"/> <? }   else if($user2['user_rank_name']=="Senior Manager"){?><img src="images/sm2.png" class="iicon"/><?php }else if($user2['designation']=='Affiliate'){ ?><img src="images/man.png" class="iicon"/> <? }else if($user2['designation']=='Free User'){ ?><img src="images/redman.png" class="iicon"/> <? }   else if($user2['user_rank_name']=="Group Manager"){?><img src="images/group-manager.png" class="iicon"/><?php }else if($user2['user_rank_name']=="Director"){?><img src="images/director.png" class="iicon"/><?php }  else if($user2['user_rank_name']=="Normal User"){?><img src="images/member.gif" class="iicon"/><?php }  else{?><img src="images/user.png" class="iicon"/><br/><?php } ?><br /><?php if($user2['user_id']!='') { ?>
...
<tr>
                                ...
                                <li>
                                  ...
                                  <a <?php if($info2 !='' && $user4['user_id']==''){ ?> href="register.php?pl_id=<?=$info2;?>&sponsor_id=<?=$id;?>&binary_pos=right"  target="_blank" <?php } else { ?> href="binary-tree.php?id=<?=$user4['user_id']?>" <?php } ?> class="tooltip1"> <?php if($user4['user_rank_name']=="Manager Mentor"){?><img src="images/manager-mentor.png" class="iicon"/><?php }else if($user4['designation']=='Affiliate'){ ?><img src="images/man.png" class="iicon"/> <? }else if($user4['designation']=='Free User'){ ?><img src="images/redman.png" class="iicon"/> <? }  else if($user4['user_rank_name']=="Manager"){?><img src="images/manager.png" class="iicon"/><?php }else if($user4['user_rank_name']=="Senior Manager"){?><img src="images/sm2.png"  class="iicon"/><?php }else if($user4['user_rank_name']=="Group Manager"){?><img src="images/group-manager.png"  class="iicon"/><?php }else if($user4['user_rank_name']=="Director"){?><img src="images/director.png"  class="iicon"/><?php }  else if($user4['user_rank_name']=="Normal User"){?><img src="images/member.gif" class="iicon"/><?php }  else{?><img src="images/user.png"  class="iicon"/><br/><?php } ?><?php if($user4['user_id']!='') { ?>
  ...
  <tr>
                          ...
                          <li>
                           ...
                           <a <?php if($info1 !='' && $user5['user_id']==''){ ?> href="register.php?pl_id=<?=$info1;?>&sponsor_id=<?=$id;?>&binary_pos=right"  target="_blank" <?php } else { ?> href="binary-tree.php?id=<?=$user5['user_id']?>" <?php } ?> class="tooltip1"> <?php if($user5['user_rank_name']=="Manager Mentor"){?><img src="images/manager-mentor.png" class="iicon"/><?php }else if($user5['user_rank_name']=="Manager"){?><img src="images/manager.png" class="iicon"/><?php }else if($user5['user_rank_name']=="Senior Manager"){?><img src="images/sm2.png" class="iicon"/><?php }else if($user5['user_rank_name']=="Group Manager"){?><img src="images/group-manager.png" class="iicon"/><?php }else if($user5['designation']=='Affiliate'){ ?><img src="images/man.png" class="iicon"/> <? }else if($user5['designation']=='Free User'){ ?><img src="images/redman.png" class="iicon"/> <? }  else if($user5['user_rank_name']=="Director"){?><img src="images/director.png" class="iicon"/><?php }  else if($user5['user_rank_name']=="Normal User"){?><img src="images/member.gif" class="iicon"/><?php }  else{?><img src="images/user.png" class="iicon"/><br/><?php } ?><?php if($user5['user_id']!='') { ?>
 ...
 <tr>
  ...
  <tr>
                                  ...
                                  <li>
                                     ...
                                     <a <?php if($info5 !='' && $user7['user_id']==''){ ?> href="register.php?pl_id=<?=$info5;?>&sponsor_id=<?=$id;?>&binary_pos=right"  target="_blank" <?php }   else { ?> href="binary-tree.php?id=<?=$user7['user_id']?>" <?php } ?> class="tooltip1"> <?php if($user7['user_rank_name']=="Manager Mentor"){?><img src="images/manager-mentor.png" class="iicon"/><?php }else if($user7['user_rank_name']=="Manager"){?><img src="images/manager.png"  class="iicon"/><?php }else if($user7['user_rank_name']=="Senior Manager"){?><img src="images/sm2.png" class="iicon"/><?php }else if($user7['user_rank_name']=="Group Manager"){?><img src="images/group-manager.png" class="iicon"/><?php }else if($user7['designation']=='Affiliate'){ ?><img src="images/man.png" class="iicon"/> <? }else if($user7['designation']=='Free User'){ ?><img src="images/redman.png" class="iicon"/> <? }else if($user7['user_rank_name']=="Director"){?><img src="images/director.png"  class="iicon"/><?php }  else if($user7['user_rank_name']=="Normal User"){?><img src="images/member.gif" class="iicon"/><?php }  else {?><img src="images/user.png" class="iicon"/><br/><?php } ?> <?php if($user7['user_id']!='') { ?>
   ...
   <tr>
                    ...
                    <li>
                    <a <?php if($userid !='' && $user8['user_id']==''){ ?> href="register.php?pl_id=<?=$userid;?>&sponsor_id=<?=$id;?>&binary_pos=right" target="_blank"  <?php } else { ?>  href="binary-tree.php?id=<?=$user8['user_id']?>" <?php } ?> class="tooltip1">   <?php if($user8['user_rank_name']=="Manager Mentor"){?><img src="images/manager-mentor.png" class="iicon"/><?php }else if($user8['designation']=='Affiliate'){ ?><img src="images/man.png" class="iicon"/> <? }else if($user8['designation']=='Free User'){ ?><img src="images/redman.png" class="iicon"/> <? }  else if($user8['user_rank_name']=="Manager"){?><img src="images/manager.png" class="iicon"/><?php }else if($user8['user_rank_name']=="Senior Manager"){?><img src="images/sm2.png" class="iicon"/><?php }else if($user8['user_rank_name']=="Group Manager"){?><img src="images/group-manager.png" class="iicon"/><?php }else if($user8['user_rank_name']=="Director"){?><img src="images/director.png" class="iicon"/><?php }  else if($user8['user_rank_name']=="Normal User"){?><img src="images/member.gif" class="iicon"/><?php }  else{?><img src="images/user.png" class="iicon"/><br/><?php } ?> <?php if($user8['user_id']!='') { ?>
   ...
   <tr>
                      ...
                      <ul>
                        ...
                        <li>
                          <a <?php if($info8 !='' && $user9['user_id']==''){ ?> href="register.php?pl_id=<?=$info8;?>&sponsor_id=<?=$id;?>&binary_pos=left" target="_blank"  <?php } else { ?> href="binary-tree.php?id=<?=$user9['user_id']?>" <?php } ?> class="tooltip1"> <?php if($user9['user_rank_name']=="Manager Mentor"){?><img src="images/manager-mentor.png" class="iicon" /><?php }else if($user9['designation']=='Affiliate'){ ?><img src="images/man.png" class="iicon"/> <? }else if($user9['designation']=='Free User'){ ?><img src="images/redman.png" class="iicon"/> <? }  else if($user9['user_rank_name']=="Manager"){?><img src="images/manager.png" class="iicon"/><?php }else if($user9['user_rank_name']=="Senior Manager"){?><img src="images/sm2.png" class="iicon"/><?php }else if($user9['user_rank_name']=="Group Manager"){?><img src="images/group-manager.png" class="iicon"/><?php }else if($user9['user_rank_name']=="Director"){?><img src="images/director.png" class="iicon"/><?php }  else if($user9['user_rank_name']=="Normal User"){?><img src="images/member.gif" class="iicon"/><?php }  else{?><img src="images/user.png" class="iicon"/><br/><?php } ?><?php if($user9['user_id']!='') { ?>
  ...
  <tr>
                            ...
                            <ul>
                              ...
                              <li>
                               <a <?php if($info9 !='' && $user10['user_id']==''){ ?> href="register.php?pl_id=<?=$info9;?>&sponsor_id=<?=$id;?>&binary_pos=left"  target="_blank" <?php } else { ?>  href="binary-tree.php?id=<?=$user10['user_id']?>" <?php } ?> class="tooltip1"><?php if($user10['user_rank_name']=="Manager Mentor"){?><img src="images/manager-mentor.png" class="iicon" /><?php }else if($user10['designation']=='Affiliate'){ ?><img src="images/man.png" class="iicon"/> <? }else if($user10['designation']=='Free User'){ ?><img src="images/redman.png" class="iicon"/> <? }  else if($user10['user_rank_name']=="Manager"){?><img src="images/manager.png"  class="iicon" /><?php }else if($user10['user_rank_name']=="Senior Manager"){?><img src="images/sm2.png" class="iicon" /><?php }else if($user10['user_rank_name']=="Group Manager"){?><img src="images/group-manager.png" class="iicon" /><?php }else if($user10['user_rank_name']=="Director"){?><img src="images/director.png" class="iicon" /><?php }  else if($user10['user_rank_name']=="Normal User"){?><img src="images/member.gif" class="iicon" /><?php }  else{?><img src="images/user.png" class="iicon" /><br/><?php } ?><?php if($user10['user_id']!='') { ?>
  <br/><?=$user10['user_id']?><br/><?=$user10['first_name']?>  <br/> <?php echo date('d-m-Y',strtotime($user10['registration_date']));?>
                                ...
                                <li>
                                  <a <?php if($info9 !='' && $user11['user_id']==''){ ?> href="register.php?pl_id=<?=$info9;?>&sponsor_id=<?=$id;?>&binary_pos=right" target="_blank"  <?php } else { ?>  href="binary-tree.php?id=<?=$user11['user_id']?>" <?php } ?> class="tooltip1">  <?php if($user11['user_rank_name']=="Manager Mentor"){?><img src="images/manager-mentor.png" class="iicon" /><?php }else if($user11['user_rank_name']=="Manager"){?><img src="images/manager.png" class="iicon" /><?php }else if($user11['designation']=='Affiliate'){ ?><img src="images/man.png" class="iicon"/> <? }else if($user11['designation']=='Free User'){ ?><img src="images/redman.png" class="iicon"/> <? }  else if($user11['user_rank_name']=="Senior Manager"){?><img src="images/sm2.png" class="iicon" /><?php }else if($user11['user_rank_name']=="Group Manager"){?><img src="images/group-manager.png" height="45" class="iicon" /><?php }else if($user11['user_rank_name']=="Director"){?><img src="images/director.png" class="iicon" /><?php }  else if($user11['user_rank_name']=="Normal User"){?><img src="images/member.gif" class="iicon" /><?php }  else{?><img src="images/user.png" class="iicon" /><br/><?php } ?> <?php if($user11['user_id']!='') { ?>
  ...
  <tr>
                          ...
                          <li>
                            <a <?php if($info8 !='' && $user12['user_id']==''){ ?> href="register.php?pl_id=<?=$info8;?>&sponsor_id=<?=$id;?>&binary_pos=right"  target="_blank" <?php } else { ?>  href="binary-tree.php?id=<?=$user12['user_id']?>" <?php } ?> class="tooltip1">  <?php if($user12['user_rank_name']=="Manager Mentor"){?><img src="images/manager-mentor.png" class="iicon" /><?php }else if($user12['user_rank_name']=="Manager"){?><img src="images/manager.png" class="iicon" /><?php }else if($user12['designation']=='Affiliate'){ ?><img src="images/man.png" class="iicon"/> <? }else if($user12['designation']=='Free User'){ ?><img src="images/redman.png" class="iicon"/> <? }  else if($user12['user_rank_name']=="Senior Manager"){?><img src="images/sm2.png" class="iicon" /><?php }else if($user12['user_rank_name']=="Group Manager"){?><img src="images/group-manager.png" class="iicon" /><?php }else if($user12['user_rank_name']=="Director"){?><img src="images/director.png" class="iicon" /><?php }  else if($user12['user_rank_name']=="Normal User"){?><img src="images/member.gif" class="iicon" /><?php }  else{?><img src="images/user.png"  class="iicon" /><br/><?php } ?><?php if($user12['user_id']!='') { ?>
  ...
  <tr>
                                  ...
                                  <li>
                                   <a <?php if($info12 !='' && $user14['user_id']==''){ ?> href="register.php?pl_id=<?=$info12;?>&sponsor_id=<?=$id;?>&binary_pos=right" target="_blank"  <?php } else { ?>  href="binary-tree.php?id=<?=$user14['user_id']?>" <?php } ?> class="tooltip1">  <?php if($user14['user_rank_name']=="Manager Mentor"){?><img src="images/manager-mentor.png" class="iicon" /><?php }else if($user14['user_rank_name']=="Manager"){?><img src="images/manager.png" class="iicon" /><?php }else if($user14['designation']=='Affiliate'){ ?><img src="images/man.png" class="iicon"/> <? }else if($user14['designation']=='Free User'){ ?><img src="images/redman.png" class="iicon"/> <? }   else if($user14['user_rank_name']=="Senior Manager"){?><img src="images/sm2.png" class="iicon" /><?php } else if($user14['user_rank_name']=="Group Manager"){?><img src="images/group-manager.png" class="iicon" /><?php } else if($user14['user_rank_name']=="Director"){?><img src="images/director.png" class="iicon" /><?php } else if($user14['user_rank_name']=="Normal User"){?><img src="images/member.gif" class="iicon" /><?php }  else{?><img src="images/user.png" class="iicon" /><br/><?php } ?>   <?php if($user14['user_id']!='') { ?>
