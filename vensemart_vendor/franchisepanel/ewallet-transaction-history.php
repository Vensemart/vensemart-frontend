                ...
                <div class="panel-body">
                  ...
                  <table class="table datatable">
                    ...
                    <tbody>
                     ...
                     <?php
                      $i=1;
                     // echo "select * from poc_credit_debit where user_id='$userid' and ewallet_used_by='Payout Wallet' order by id desc";
                      $data=mysqli_query($GLOBALS["___mysqli_ston"], "select * from poc_credit_debit where user_id='$userid'  order by id desc");
