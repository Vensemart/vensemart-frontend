           ...
           <form name="bankinfo" method="post" action="external-fund-transfer-confirm1.php">
              <section class="panel">
                ...
                <header class="panel-heading">
                  <h3 class="panel-title">Payout To Fund Wallet Transfer</h3>
                </header>
                <header class="panel-heading">
                 <br/> <h3 class="panel-title">Payout Wallet Ballance : USD <?php $data=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select * from commission_e_wallet where user_id='$userid'"));?><strong><?php  echo number_format($data['amount'],2);?></strong> </h3>
                <br/></header>
