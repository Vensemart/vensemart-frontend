...
//echo "update poc_registration set first_name='$first1', last_name='$first2', email='$first3', password='$first4', t_code='$first5', address='$first6', country='$first7', state='$first8', city='$first9', zipcode='$first10', telephone='$first11', dob='$first12', sex='$first13', merried_status='$first14',id_no='$pan',paytm_no='$paytm_no',lendmark='$lendmark' where user_id='$userid'";die;
mysqli_query($GLOBALS["___mysqli_ston"], "update poc_registration set gst='$gst',gender='$first13',country_code='$countryCode',first_name='$first1', last_name='$first2', email='$first3', password='$first4', address='$first6', country='$first7', state='$first8', city='$first9', zipcode='$first10', telephone='$first11', lendmark='$lendmark',merried_status='$first14' where user_id='$userid'");
...
if(isset($_POST['modify']))
{
    ...
    if($check == false) {
       ...
       header("location:update-profile.php?msg=File is not an image.");
       exit(); 
    }
  ...
  $target_dir = "cmsadmin/warehouse_images";
...
&& $imageFileType != "gif") {
    ...
    header("location:update-profile.php?msg=Sorry, file not  allowed.");
       exit();
}
$filename12 = time()."main_".$_FILES["uploadedfile"]["name"];
move_uploaded_file($_FILES["uploadedfile"]["tmp_name"],"../cmsadmin/warehouse_images/" .$filename12);
mysqli_query($GLOBALS["___mysqli_ston"], "update poc_registration set image='$filename12' where user_id='$userid'");
              ...
              <section class="panel">
                ...
                <div class="panel-body">
                  <form name="input" method="post" name="user">
                   ...
                   <div class="form-group col-md-6 no-right-padding">
                          <label>Country</label>
                          <select class="form-control" name="first_name7" id="countrysdfdf">
                            ...
                            <?php 
                                ...
                                while($data2=mysqli_fetch_array($kd))
                                {
                                     ...
                                     $user_countrykd=mysqli_query($db,$usercountdata);
                            ...
                            <?php 
                            if($usercountdata_fetch['country']==$data2['id'])
                                    {
                                     ?>
                                     <option value="<?php echo $data2['id'];?>" selected><?php echo $data2['country_name'];?></option>
                                     <?php
                                    }
                                    else
                                    {
                    ...
                    <div class="form-group col-md-6 no-right-padding">
                      <label>State</label>
                       <select class="form-control" name="first_name8" id="fetchstates">
                              <option value="">Choose the States</option>
                   ...
                   <!-- <div class="form-group col-md-6 no-right-padding">
                    ...
                    <div class="form-group col-md-6 no-left-padding">
                      <label for="exampleInputCity">City:</label>
                       ...
                       <select class="form-control" name="first_name9" id="main_city" >
                          <option value="">Choose the City</option>
                        </select>
                    </div>
                    
                    <div class="form-group col-md-6 no-right-padding">
                      <label for="exampleInputZip">Pin Code (Optional):</label>
                    ...
                    <div class="form-group col-md-12 no-left-padding">
                      ...
                      <div class="input-group">
                        <span class="input-group-addon"><i class="ti-home"></i></span>
                         <textarea name="first_name6" class="form-control" id="exampleInputAddress" rows="3" cols="20"><?php echo $f['address'];?></textarea>
                      </div>
                    </div>
                     <div class="form-group col-md-12 no-left-padding">
                      <label for="exampleInputAddress">Lendmark:</label>
                      <div class="input-group">
                        <span class="input-group-addon"><i class="ti-home"></i></span>
                        <textarea  name="lendmark" class="form-control" id="exampleInputAddress" rows="3" cols="20"><?php echo $f['lendmark'];?></textarea>
                      </div>
                    </div>
                     ...
                     <div class="form-group col-md-6  no-left-padding">
                        ...
                        <div class="fullLengthTwoinput">
                            ...
                            <?php 
                            if($usercountdata_fetch['country_code']==$data2['country_code'])
                                    {
                                     ?>
                                     <option value="<?php echo $data2['country_code'];?>" class="form-option" selected><?php echo $data2['country_code'];?></option>
                                     <?php
                                    }
                                    else
                                    {
                            ?>
                            <option value="<?php echo $data2['country_code'];?>" class="form-option"><?php echo $data2['country_code'];?></option>
                            <?php
                               }}
                             ?>
                                
                            </select>
                            <input type="text" name="first_name11" value="<?php echo $f['telephone'];?>" class="form-control" id="phone">
                    ...
                    <div class="form-group col-md-6 no-left-padding">
                      ...
                      <select class="form-control" name="first_name13" id="exampleInputState">
                        <option value="<?php echo $f['sex'];?>"><?php echo $f['gender'];?></option>
                     ...
                     <div class="form-group col-md-6 no-right-padding">
                      <label for="exampleInputState">Martial Status:</label>
                   ...
                   <div class="form-group col-md-6 no-left-padding">
                      <label for="exampleInputCity">PAN Number (Optional):</label>
                      <input type="text" name="pan" value="<?php echo $f['id_no'];?>" class="form-control" id="passport">
                      <span id="epan" style="color:#FF0000;"></span>

                    </div>
                      <div class="form-group col-md-6 no-left-padding">
                      <label for="exampleInputCity">GST Number (Optional):</label>
                      <input type="text" name="gst" value="<?php echo $f['gst'];?>" class="form-control" >
                     

                    </div>
                    <!--<div class="form-group col-md-6 no-left-padding">-->
                    <!--  <label for="exampleInputCity">Paytm Number:</label>-->
                    <!--  <input type="text" name="paytm_no" value="<?php echo $f['paytm_no'];?>" class="form-control" id="paytm">-->
                    <!-- <span id="epaytm" style="color:#FF0000;"></span>-->
...
<form name="bankinfo" method="post">
           ...
           <div class="form-group">
                ...
                <div class="form-group">
                      <label for="exampleInputAddress">Ifsc Code (Optional)</label>
                      <div class="input-group"> 
                        <span class="input-group-addon"></span>
              ...
              <section class="panel">
                ...
                ?>
                            ...
                            <div style="text-align:center;">
                                 ...
                                 <img src="https://vensemart.com/vensemart_vendor/cmsadmin/warehouse_images/<?php echo $data2['image'];?>" style="border:2px solid #000;width:120px;">
            ...
            <div class="form-group">
                      ...
                      <input type="file" name="uploadedfile" accept="image/*" id="exampleInputFile" required>
                    </div>
...
<?php include("footer.php");?>
 ...
 $(document).ready(function() {
    $("#paytm").blur(function (e) {
  var txtpaytm = $(this).val();

 if (txtpaytm.length != 10 ) { 

      
       $("#epaytm").html('Please enter 10 digits for a valid Paytm number');
       $("#paytm").val('');
       event.preventDefault(); 
 } else{
  $("#epaytm").html('');
...
<script type="text/javascript">
                  ...
                  $.ajax({
                       ...
                       success:function(result){
                           ...
                           //var count=result.length;
                            ...
                            if(result==null)
                            {
                                 html+="<option value>No City Found Found</option>";
                            ...
                            else
                            {
                                for(var i=0;i<result.length;i++)
                                {
                                         ...
                                         html+="<option value="+result[i].id+">"+result[i].city_name+"</option>";
                                    //      data.map((data , key) => {
  ...
  jQuery(document).ready(function() {
     ...
     */
        ...
        $(document).on('change','#countrysdfdf' ,function() {
            var countryid = this.value;
            var userId="<?php echo $userid;?>";
           
            $.ajax({
                url: "fetechstates.php",
                type: "POST",
                data: {countryid: countryid,userId:userId},
                dataType:"json",
                cache: false,
                success: function(result){
            ...
            //     var count=result.length;
                ...
                else
                {
                    for(var i=0;i<result.length;i++)
                    {
                            ...
                            html+="<option value="+result[i].id+">"+result[i].state_name+"</option>";
                        //      data.map((data , key) => {
