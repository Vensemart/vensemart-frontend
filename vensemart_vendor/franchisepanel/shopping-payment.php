...
<html lang="en">
  ...
  <section id="page-title" class="row">
          ...
          <div class="col-md-8">
            ...
            <p><div align="center" style="color:#900;font-weight:bold;"><?php echo "You are going to pay ".$_SESSION['ag']." INR Please choose an option to pay!!!";?></div></p>
          </div>
                            ...
                            <input type="hidden" name="action" value="">
                              <div class="panel-body text-left">
                                  <section class="col col-12">
                                     <!-- <div class="col-md-6">
                                        <a href="pin-payment.php"><img src="../images/prepaid.png"></a>
                                       </div>-->
                                      <div class="col-md-12">
