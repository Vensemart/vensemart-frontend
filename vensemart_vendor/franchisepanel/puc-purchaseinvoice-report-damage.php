      ...
      <div class="modal-body">
        <form method="POST">
            ...
            <tr>
                    ...
                    <td>
                      <input type="text" class="form-control" name="receiver_id" id="puc" placeholder="Enter Receiver Id." value="<?php echo $data21['receiver_id'];?>">
            ...
            <div class="col-md-12">
              ...
              <section class="panel panel-primary">
                <header class="panel-heading">
                  <h4 class="panel-title">Billing Invoices</h4>
                </header>
                  ...
                  <table class="table datatable">
                    ...
                    <tbody>
                     ...
                     <?php
                      ...
                      // exit();
                      $data=mysqli_query($GLOBALS["___mysqli_ston"],  "select * from  amount_detail where puc='$userid' and damage_status=1 $query123 order by am_id desc");
                     ...
                     ?>
                      ...
                      <tr>
                        ...
                        <td>
                        <?php if($data1['delst']=='0' && $data1['payment_mode']!='Direct Bank Transfer' && $data1['status']=='0'){ ?>
                                  <!--<a href="check_product.php?aid=<?php echo $data1['am_id'];?>"   class='btn btn-primary'>Confirm</a>-->
                                  <a href="check_product_otp.php?aid=<?php echo $data1['am_id'];?>"   class='btn btn-primary'>Confirm</a>
                                 <?php }else if($data1['delst']=='0' && $data1['status']=='1' && $data1['payment_mode']=='Direct Bank Transfer'){ ?>
