             ...
             <div class="row">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-12 text-right">
                        ...
                        <!-- <a href="searching_export_excel.php?idd<?php echo "'.$query123 .'"?>" class="btn btn-success">export in excel</a> -->
     ...
     <form class="form-inline" role="form" method="post" autocomplete="off">
                           ...
                           <table class="table responsive-data-table table-responsive data-table">
                            ...
                            <?php 
                                  ...
                                  $data=mysqli_query($GLOBALS["___mysqli_ston"], "select * from closing_credit_debit where 1  $query123");
                  ...
                  <td><?php echo $data1['binary_income'];?></td>
                        ...
                        <td><?php echo $data1['sales_reward'];?></td>
                         ...
                         <td><?php echo $data1['fund_income'];?></td>
                           ...
                           <td><?php echo $data1['award_income'];?></td>
