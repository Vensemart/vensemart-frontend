...
$start = "2021-02-01";
 ...
 $tbvsks=$finder_perosnal_bvks + $finder_team_bvks;
if ($finder_perosnal_bvks>=500 && $tbvsks>=6000) {
echo  $uid                = $rds['user_id'];echo"<br>";
echo   $rds['first_name'];echo"<br>";
 $comm=$rds['director_per'];
