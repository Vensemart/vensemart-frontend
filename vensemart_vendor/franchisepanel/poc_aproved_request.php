            ...
            <div class="col-md-12">
              ...
              <section class="panel panel-primary">
                <header class="panel-heading">
                  <h4 class="panel-title">Approved Request</h4>
                </header>
                  ...
                  <table class="table datatable">
                    ...
                    <tbody>
                            ...
                            <tr style="text-align:center;">
                                ...
                                <td>
                                    <?php $user=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select * from user_registration where user_id='".$data1['user']."'")); echo $user['user_id'];?>
                                </td>
