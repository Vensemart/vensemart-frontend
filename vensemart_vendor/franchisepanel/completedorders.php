            ...
            <div class="col-md-12">
              ...
              <section class="panel panel-primary">
                <header class="panel-heading">
                  <h4 class="panel-title">Completed Orders List</h4>
                </header>
                ...
                <table class="table datatable">
                    ...
                    <tbody>
                        ...
                        $store_id=$storedata['id'];
                            $i=1;
                            $data=mysqli_query($GLOBALS["___mysqli_ston"], "select * from  orders  where orders.shop_id='$store_id' and orders.status=4 ORDER BY id DESC");
