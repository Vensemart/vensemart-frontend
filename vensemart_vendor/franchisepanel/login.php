        ...
        <div class="col-md-4 center-block">
            <div class="registration">
                <div class="registration-body">
                    ...
                    <h3 class="heading">Login to <?php echo PROJECT_NAME;?> </h3>

                    <form action="../post-action.php" method="post">
                        <input name="action" type="hidden" value="pocloginuser" />
                        <?php if($_GET['msg']!='') { ?>
                            <p class="text-center">
                                <div style="color:red; font-size:14px;font-weight:bold;"><span style="color:#F00;padding-left:10px;"><?php if($_GET['msg']=='wrong') { echo "Wrong Credential Details!";} else if($_GET['msg']=='logout') { echo "You Are Logout!";} else if($_GET['msg']=='Wrong Security Code') { echo "Please Fill correct captcha.";}  else if($_GET['msg']=='approval') { echo "Please Wait for the Admin Approval";} else { echo urldecode($_GET['msg']); } ?></span>
                                    <br/>
                                    <br/>
                                </div>
                            </p>
                            <?php } ?>
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control text1" id="username" placeholder="Userid" name="username" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group text-center">
                                    <input type="submit" name="submit" value="Sign in" class="btn btn btn-primary btn-block">
                                </div>
                ...
                <div class="row register-footer">
                    <div class="col-md-5 col-sm-12">
                        <a href="registration_new.php">Register Here</a>
                    </div>
                    <div class="col-md-7 col-sm-12">
                        <!--<p class="forgotPwd"><a href="forgotpoc.php"><i>Forgot Your Password?</i></a></p>-->
                    </div>
                </div>
