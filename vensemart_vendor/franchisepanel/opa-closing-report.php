...
<div class="col-sm-12">
<form name="tree" method="post" action="../opa_closing.php" >
...
<input type="submit" name="submits" value="Submit" class="btn btn-success"> 
                ...
                <div class="row">
                    <<!-- div class="col-sm-12 text-right">
                        <a href="export-leadership-income-closing-reports.php"  class="btn btn-success">Export In Excel</a> 
                    </div> -->
                    <div class="col-sm-12">
                        <section class="panel">
                            <header class="panel-heading ">
                                 Outepermomer Annual Bonus Closing Report<span style="float:right;color:red;"><?php echo @$_GET['msg'];?></span>
    ...
    <div class="total_invoice"  id="printArea">
                            ...
                            <?php 
                                  ...
                                  $total=0;
                                  $date=date('Y-m-d');
                                  $data=mysqli_query($GLOBALS["___mysqli_ston"], "select * from credit_debit where ttype='OPA Income'  and receive_date='".date('Y-m-d')."'");
