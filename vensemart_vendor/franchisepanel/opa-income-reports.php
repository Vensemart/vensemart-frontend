                        ...
                        <table border="1px" class="table table-bordered table-hover role" style="background:#FFF; border-color:#000;">
                          ...
                          <tbody>
                            <?php
                              ...
                              $config_query_count="SELECT count(id) as counter from credit_debit where ttype='Quick Promotion Bonus' ";
                              $config_query_record="SELECT * from credit_debit where ttype='Quick Promotion Bonus' ";
