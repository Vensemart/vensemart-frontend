...
<!--                                    <h4 class="m-t-0 header-title"><b>Loyality Bonus-->
<!--</b></h4>-->
                                     <h4 class="m-t-0 header-title"><b>Franchise Direct Income
</b></h4>
                                   ...
                                   <thead>
                                        ...
                                        <?php
                      $i=1;
                      $data=mysqli_query($GLOBALS["___mysqli_ston"], "select * from credit_debit where user_id='$userid' and ttype='Franchise Direct Income' order by id desc");
