 ...
 if( $_POST['t_password'] != $f['t_code'] )
      {
          ...
          echo "<script language='javascript'> alert('Wrong Transaction Password!'); window.location.href='external-fund-tranfer.php'; </script>";
        }

 if( $_POST['user'] == $f['user_id'] )
      {
      ...
      <?php include("top.php");?>
        ...
        <section id="page-title" class="row">
          ...
          <div class="col-md-4">
            ...
            <ol class="breadcrumb pull-right no-margin-bottom">
              ...
              <li><a href="#">Fund Wallet Transfer</a></li>
            </ol>
        ...
        <div class="container-fluid">
          <div class="row">
           ...
           <form name="bankinfo" method="post" action="external-fund-transfer-code.php">
              <section class="panel">

                <header class="panel-heading">
                  <h3 class="panel-title">Fund Wallet Fund Transfer confirmation</h3>
                </header>
