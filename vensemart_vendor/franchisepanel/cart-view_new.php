                            ...
                            <th width="10%">Remove</th>
                              ...
                              if(isset($_SESSION["cart_products"])) //check session var
                                ...
                                foreach ($_SESSION["cart_products"] as $cart_itm)
                                 ...
                                 $ttlgst=$gst+$ttlgst;
                                  ...
                                  echo '<td><input type="text" style="text-align:center;width: 40px;" maxlength="3" name="product_qty['.$product_id.']" value="'.$product_qty.'" /></td>';
                              ...
                              */}
                                ...
                                <tr>
                                  ...
                                  <td colspan="5"><span style="float:right;text-align: right;font-weight: bold"><?php echo $shipping_cost. $list_tax; ?>Total Amount : <?php echo $currency; echo sprintf("%01.2f", $grand_total+$ttlgst); ?></span></td></tr>
                                <tr><td colspan="2"></td>
                                
                                <td colspan="5" class="text-right">&nbsp;<a href="eshop_new.php" class="btn btn-primary">Add More Items</a> &nbsp;<button type="submit" class="btn btn-primary">Update Your Cart</button> &nbsp; <a class="btn btn-primary" href="update-billing_new.php">  <!--ewallet-payment-shop.php-->Buy Now</a></td></tr>
                              </tbody>
                            </table>
