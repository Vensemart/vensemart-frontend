...
<?php include("includes/tittle.php");?>
    ...
    <body>
        ...
        <!--    <?php }else{ ?><p style="color: red;font-style: italic;font-weight: 600;">Withdrawal can only be rquested at Tuesday</p> <?php }?> -->
            ...
            <?php      $quest=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select * from popup where id='5'"));

if ($quest['status']==1) {
 
      ?>

         <a href="withdraw-request2.php"><input type="submit" name="update" value="New Request Click Here" class="btn btn-primary btn-large"></a>  
   <?php     }   ?>
          </div>
           <div class="col-md-2">
            <!--<h1>My Withdrawal Request</h1>-->
        ...
        <section class="panel panel-primary">
                ...
                <div class="panel-body table-responsive">
                    ...
                    <tbody>
                     ...
                     <?php
                      $i=1;
                      $data=mysqli_query($GLOBALS["___mysqli_ston"], "select * from withdraw_request2 where user_id='$userid' order by id desc");
...
$data22=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select * from user_registration where user_id='".$data1['mentor']."'"));?>
                  ...
                  <td><?php echo $data1['admin_remark'];?></td>
                          ...
                          <td><?php if($data1['status']==0)
                                    { 
                                        //echo "Pending";  ?>
                                            <a href="cancelled_user_withdrawal2.php?user=<?php echo $data1['user_id'];?>&id=<?php echo $data1['id'];?>" class="btn btn-danger" title="Click To Cancel">Cancel Request</a>
                                    <?php }
                                      if($data1['status']==1)
                                    { 
                                        echo "Paid";
