 ...
 if( $_POST['password'] != $f['password'] )
      {
          ...
          echo "<script language='javascript'> alert('Wrong Transaction Password!'); window.location.href='withdraw-request.php'; </script>";
        }
?>
<!DOCTYPE html>
<html lang="en">
      ...
      <?php include("top.php");?>
        ...
        <div class="container-fluid">
          <div class="row">
           ...
           <form name="bankinfo" method="post" action="withdrawal-request-code.php">
              <section class="panel">
