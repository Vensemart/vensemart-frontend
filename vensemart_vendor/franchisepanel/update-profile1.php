...
mysqli_query($GLOBALS["___mysqli_ston"], "update user_registration set first_name='$first1', last_name='$first2', email='$first3', password='$first4', t_code='$first5', address='$first6', country='$first7', state='$first8', city='$first9', zipcode='$first10', telephone='$first11', dob='$first12', sex='$first13', merried_status='$first14', aboutus='$first15',id_no='$pan',paytm_no='$paytm_no' where user_id='$userid'");
...
mysqli_query($GLOBALS["___mysqli_ston"], "update user_registration set acc_name='$first21', bank_nm='$first23', branch_nm='$first24', ac_no='$first22', swift_code='$first25' where user_id='$userid'");
              ...
              <section class="panel">
                ...
                <div class="panel-body">
                  <form name="input" method="post" name="user">
                      ...
                      <input type="text" name="user_name" class="form-control" id="exampleInputName" value="<?php echo $f['user_name'];?>">
                    </div>
                    <div class="form-group">
                   ...
                   <div class="form-group col-md-6 no-left-padding">
                      <label for="exampleInputCity">PAN Number:</label>
           ...
           <div class="form-group">
            ...
            <div class="col-md-12">
              ...
              <section class="panel">
                ...
                <div class="panel-body">
                            <div style="text-align:center;"> <img src="<?php echo $userimage;?>" style="border:2px solid #000;width:120px;"></div><br/>
            <div class="form-group">
