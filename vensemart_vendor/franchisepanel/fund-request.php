...
<input name="wallet" id="wallet" type="hidden" tabindex="1" required class="" style="width:4%;" value="poc_e_wallet" checked="checked" />
                  ...
                  <div class="form-group">
                        ...
                        <input type="number" name="amounts" required value="" class="form-control" >
                              ...
                              <div class="form-group">
								...
								<div class="form-group">
									...
									<div class="form_input">
										<select data-placeholder="Bank"  class="form-control" name="account_number" id="account_number" required>
					...
					<div class="form-group" id="uttr">
                      <label for="exampleInputAddress">Enter Transaction / Reference / UTR Number</label>
                      <div class="input-group">
                        <span class="input-group-addon"></span>
                        <input type="text" name="transaction_nu" id="transaction_nu" class="form-control" >
                      </div>
                    </div>
                    
                    <div class="form-group" id="brcode">
                      <label for="exampleInputAddress">Branch Code</label>
                      <div class="input-group">
                        <span class="input-group-addon"></span>
...
<?php include("footer.php");?>
 ...
 <?php include("rightside-panel.php");?>
  ...
  if (paymentType == 'CASH') {
    $("#transaction_nu").prop('required', false);
    $("#uttr").hide("fast");
    $("#brcode").show("fast");
    $("#branch_name").prop('required', true);
  } else {
    $("#uttr").show("fast");  
    $("#transaction_nu").prop('required', true);
    $("#brcode").hide("fast");
