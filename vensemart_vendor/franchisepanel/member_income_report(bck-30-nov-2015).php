...
sayfa.print();
    ...
    <div class="total_invoice"  id="printArea">
               ...
               <tr>
                    ...
                    <tr>
                      ...
                      $sql12=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select sum(credit_amt) as totamt from credit_debit where user_id='$userid' and ttype='Sponsor Income' "));
           ...
           ?>
                        ...
                        <td style="font-size:14px">$<?php echo $a1=$tot;?></td>
            ...
            $sql124=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select sum(credit_amt) as totamt4 from credit_debit where user_id='$userid' and ttype='Binary Income' "));
           ...
           ?>
                        ...
                        <td style="font-size:14px">$<?php echo $a2= $tot1;?></td>
 ...
 $bonus=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select sum(credit_amt) as lead1 from credit_debit where user_id='$userid' and ttype='Matching Income' "));
           ...
           ?>
                        ...
                        <td style="font-size:14px">$<?php echo $a3=$tot12;?></td>      
           ...
           ?>
            ...
            $bonus123=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select sum(credit_amt) as leadtot12 from credit_debit where user_id='$userid' and ttype='Rank Bonus' "));
           ...
           ?>
                        ...
                        <td style="font-size:14px">$<?php echo $a5=$tote123;?></td> 
                    </tr>
