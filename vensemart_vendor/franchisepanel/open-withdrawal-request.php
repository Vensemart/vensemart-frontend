                    ...
                    <div class="col-sm-12">
                        <section class="panel">
                            ...
                            <tr style="text-align:center;">
                                ...
                                <td>
                                     <a href="cancelled_withdrawal.php?user=<?php echo $banners['user_id'];?>&id=<?php echo $banners['id'];?>">Cancel Request</a>
                                </td>
                                ...
                                <td><?php echo $fetcho['telephone'] ;?></td>
                                  
                                 <td>
                                      <td><?php echo $fetcho['country'] ;?></td>
