    ...
    <form action="raiseticket_func.php" method="post" class="form_container left_label">
                      ...
                      <option>Others </option>
								...
								<div class="form_grid_12">
									...
									<div class="form_input">
										<input name="filed01" type="text" tabindex="1" style="width:100%; border:1px solid #ebebeb; padding:5px;" class="form-control" id="exampleInputAddress" />
									</div>
								</div>
								<div class="form_grid_12">
									<label class="field_title">Message </label>
									<div class="form_input">
										<textarea name="filed06" style="width:100%; border:1px solid #ebebeb; padding:5px;" class="form-control" id="exampleInputAddress" cols="50" rows="5" tabindex="5" ></textarea>
									</div>
								</div>
								<div class="form_grid_12">
									<div class="form_input">
