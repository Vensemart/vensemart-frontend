                      ...
                      <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box table-responsive">
                                    ...
                                    <h4 class="m-t-0 header-title"><b>Sales Rank Reward
</b></h4>
                                   ...
                                   <thead>
                                        ...
                                        <?php
                      $i=1;
                    //   $data=mysqli_query($GLOBALS["___mysqli_ston"], "select * from credit_debit where user_id='$userid' and ttype='Champion Bonus' order by id desc");
                     $data=mysqli_query($GLOBALS["___mysqli_ston"], "select * from credit_debit where user_id='$userid' and ttype='Sales Rank Reward' order by id desc");
                      ...
                      <tr>
                       ...
                       <!--  <td><?php echo $data1['sender_id'];?></td>
                        <?php $data11=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select * from user_registration where user_id='".$data1['sender_id']."'"));?>
                         ...
                         $data112=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select * from user_registration where user_id='".$data1['sender_id']."'"));
                         echo $data112['username'];?></td>  -->
                       <!--     <td><?php echo $data1['Remark'];?></td> -->
                          <td><?php echo $data1['credit_amt']+$data1['admin_charge'];?></td>
