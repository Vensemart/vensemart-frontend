...
<html lang="en">
  ...
  <script type="text/javascript">
    ...
    <title>Glit Global Limited Registration</title>
             ...
             <input type="hidden" name="action" value="UserRegistration">   
              <?php @$msg=$_GET['msg'];if($msg!='') { ?>
                     <div class="reg-header">
                      ...
                      ?>
                      <option value="<?php echo $queryf1['id'];?>"><?php echo $queryf1['name'];?> ( USD <?php echo $queryf1['amount'];?> )</option>
                      <?php } ?>
                                                        </select>
                                                    </div>
