        ...
        <div class="body-content" >
            ...
            <div class="wrapper">
              ...
              <!--       <div class="col-sm-12 text-right">
                           <a href="export_repurchase_level_income_report.php" class="btn btn-success">Export in excel</a>
                        ...
                        <table border="1px" class="table table-bordered table-hover role" style="background:#FFF; border-color:#000;">
                          ...
                          <tbody>
                            <?php
                              ...
                              $config_query_count="SELECT count(id) as counter from credit_debit where ttype='Super Champion Bonus' ";
                         $config_query_record="SELECT * from credit_debit where ttype='Super Champion Bonus' ";
 ...
 ?>
                            <tr style="text-align:center;">
                              ...
                              <!--   <td>
                                ...
                                <td>
                                     <?php echo $row_config['TranDescription'];?>
                                </td> -->
                                <td>
