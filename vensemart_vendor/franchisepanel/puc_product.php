...
$results1=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM user_registration WHERE (user_id='".$_POST['puc_name']."' || username='".$_POST['puc_name']."')"));

  if($results1['user_id']!='') {
      
     $_SESSION['BillingType']=$_POST['BillingType'];
    $_SESSION['puc']=$results1['user_id'];
     header('Location:eshop.php');
       exit;
  }else{
      header('Location:puc_product.php?msg=user not Available');
       exit;
  }
           ...
           <input type="hidden" name="pay_method" value="final_e_wallet_pay">
              <section class="panel">
                ...
                <header class="panel-heading">
                  <h3 class="panel-title"><strong>Select User</strong></h3>
                </header>
              ...
              <div class="form-group">
                   ...
                   <!--   <div class="form-group">
                        <label for="exampleInputAddress">Select Billing Type</label>
                          <div class="input-group">
                              <span class="input-group-addon"></span>
                             
                                <select name="BillingType" class="form-control" required>
                                  <option value="0">-Select Billing Type-</option>
                                  <option value="1">To Activation</option>
                                  <option value="2">To Upgrade</option>
                                  <option value="3">To Repurchase</option>
