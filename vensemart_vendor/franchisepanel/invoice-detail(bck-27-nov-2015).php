                    ...
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="col-xs-4">
                                ...
                                <div class="amount">
SGD <?php echo number_format($lfj['amount'],2);?>
                                </div>
                            </div>
                        </div>
                        ...
                        <table class="table table-striped table-hover">
                            ...
                            <tr>
                                <td>1</td>
                                <td>Package</td>
                                <td class="hidden-xs"><?php echo $lfj['package'];?></td>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-4">
                                <table class="table table-hover">
                                    ...
                                    <tr>
                                        <td>Subtotal</td>
                                        <td><?php echo number_format($lfj['amount'],2);?> SGD</td>
                                    </tr>
                                    <tr>
                                        <td>Tax</td>
                                        <td>0.00</td>
                                    ...
                                    <tr>
                                        ...
                                        <td><strong><?php echo number_format($lfj['amount'],2);?> SGD</strong></td>
                                    </tr>
                                    </tbody>
                                </table>
                            </div>
